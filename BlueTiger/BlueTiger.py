...
# Funktion zur Darstellung eines Optionsblocks
...
def show_menu(menu_num=1):
    ...
    if menu_num == 1:
        # Menü 1: Network, OSINT, Security
        print(f" ┌─ {blue}[{white}I{blue}]{white} Info                                                                                                                                  {blue}[{white}N{blue}]{white} Next ─┐")
        print(" ├─ ┌─────────────────┐                    ┌───────┐                    ┌────────────┐                    │")
        print(" └─┬─┤ Network Tools   ├─────────┬──────────────┤ OSINT ├──────────────┬────────────┤ Security     ├────────────┴─")
        print("   │ └─────────────────┘                    │                       └───────┘                    │            └────────────┘")
        ...
        # Menü 2: Game Tools
        print(f" ┌─ {blue}[{white}I{blue}]{white} Info                                                                                                                                  {blue}[{white}B{blue}]{white} Back ─┐")
        print(" ├─ ┌─────────────────┐                                                                                                                                 │")
        print("─┴─┬─┤ Game Tools      ├───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┴─")
        print("   │ └─────────────────┘")
